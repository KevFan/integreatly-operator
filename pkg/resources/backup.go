...
func ReconcileBackup(ctx context.Context, serverClient pkgclient.Client, config BackupConfig, configManager productsConfig.ConfigReadWriter) error {
...
func reconcileBackendSecret(ctx context.Context, serverClient pkgclient.Client, config BackupConfig, secretName string, secretNamespace string) error {
	...
	err := serverClient.Get(ctx, pkgclient.ObjectKey{Namespace: sourceSecret.Namespace, Name: sourceSecret.Name}, sourceSecret)
	if err != nil {
...
func reconcileRole(ctx context.Context, serverClient pkgclient.Client, config BackupConfig) error {
...
func reconcileRoleBinding(ctx context.Context, serverClient pkgclient.Client, config BackupConfig) error {
					...
					Template: corev1.PodTemplateSpec{
						...
						Spec: corev1.PodSpec{
							...
							Containers: []corev1.Container{
								{
									Name:            "backup-cronjob",
									Image:           "quay.io/kevfan/backup-container:latest", //FIXME - workaround until we merge https://github.com/integr8ly/backup-container-image/pull/53
